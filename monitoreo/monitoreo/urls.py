...
from dispositivos.views import inicio, panel_dispositivos,detalle_dispositivo,crear_dispositivo,listar_dispositivos
...
urlpatterns = [
    ...
    path('dispositivos/<int:dispositivo_id>', detalle_dispositivo, name="dispositivo"),
